...
struct Varyings
{
    ...
    #if !defined(ENABLE_TERRAIN_PERPIXEL_NORMAL) && defined(_NORMALMAP) || (defined(PARALLAX)  || defined(_TERRAIN_TRIPLANAR) || defined(_TERRAIN_TRIPLANAR_ONE) || defined(_PUDDLES))  && !defined(TERRAIN_SPLAT_BASEPASS)
...
void InitializeInputData(Varyings IN, half3 normalTS, out InputData inputData)
{
    ...
    #if !defined(ENABLE_TERRAIN_PERPIXEL_NORMAL) && defined(_NORMALMAP) || defined(PARALLAX)  || defined(TRIPLANAR) || defined(_PUDDLES) && !defined(TERRAIN_SPLAT_BASEPASS)
...
Varyings SplatmapVert(Attributes v)
{
    ...
    float2 tc = _WorldMapping ? (Attributes.positionWS.xz / _TerrainSizeXZPosY.xy) : v.texcoord;
        ...
        o.uvSplat01.zw = TRANSFORM_TEX(tc, _Splat1);
            ...
            #ifdef _LAYERS_EIGHT
                o.uvSplat45.xy = TRANSFORM_TEX(tc, _Splat0);
                o.uvSplat45.zw = TRANSFORM_TEX(tc, _Splat1);
    ...
    #if !defined(ENABLE_TERRAIN_PERPIXEL_NORMAL) && defined(_NORMALMAP) || (defined(PARALLAX) || defined(TRIPLANAR) || defined(_PUDDLES))  
