...
{    
    ...
    SubShader
    {
        ...
        #pragma multi_compile_local __ _TERRAIN_TRIPLANAR_ONE
        ...
        Pass
        {
            ...
            float4 frag(v2f i) : SV_Target
            {
                float4 alpha = UNITY_SAMPLE_TEX2D(_Control, i.texcoord0);
        ...
        Pass
        {
            ...
            float4 frag(v2f i) : SV_Target
            {
                ...
                ao = 1;
                    ...
                    ao = AmbientOcclusion(mask, blendMask);
                ...
                return float4(metallic, ao, blendMask[0].r, UNITY_SAMPLE_TEX2D(_Splat0, float2(0,0)).r);
            }
            ENDCG
        }
        ...
        Pass
        {
            ...
            float4 frag(v2f i) : SV_Target
            {
                ...
                float4 mask0 = UNITY_SAMPLE_TEX2D(_Mask0, uv);
                    ...
                    float4 dMask0 = UNITY_SAMPLE_TEX2D(_Mask0, uv * (_DiffuseRemapOffset0.r + 1) * _HT_distance_scale);
        ...
        Pass
        {
            ...
            float4 frag(v2f i) : SV_Target
            {
                ...
                #if defined(_TERRAIN_MASK_MAPS) || defined(_TERRAIN_NORMAL_IN_MASK)
                    #ifdef _TERRAIN_DISTANCEBLEND
                        float4 dMask0 = UNITY_SAMPLE_TEX2D(_Mask0, uv * _HT_distance_scale);
                        mask0 = lerp(mask0, dMask0, _HT_cover);
                    #endif                            
                    #ifdef _TERRAIN_NORMAL_IN_MASK
