        ...
        void surf(Input IN, inout SurfaceOutputStandard o) {
            ...
            half4 metallicAO = tex2D(_MetallicTex, IN.tc.xy);
                ...
                if (_NumLayersCount <= 4)
                {
                    ...
                    float2 frontUV = TerrainFrontUV(IN.worldPos, _MainTex_ST, IN.tc.xy, flipUV);
                    float2 sideUV = TerrainSideUV(IN.worldPos, _MainTex_ST, IN.tc.xy, flipUV);
            ...
            o.Albedo = albedo.rgb;
            o.Alpha = 1;
            o.Smoothness = lerp(albedo.a, 1.0f, _InTerra_GlobalWetness);
